...
typedef struct 
{
  ...
  Data_frame_point_t  *Data_frame_point;  //数据段帧头格式指针
	...
	/*裁判系统数据*/
	ext_game_status_t				 ext_game_status;//比赛状态信息
	ext_power_heat_data_t            ext_power_heat_data;   //功率热量数据
	ext_game_robot_HP_t				 ext_game_robot_HP;		//机器人血量数据	
	ext_game_robot_state_t           ext_game_robot_state;  //机器人状态数据
	ext_rfid_status_t                ext_rfid_status;  //RFID状态信息
	ext_robot_hurt_t                 ext_robot_hurt;        //伤害状态数据
	ext_supply_projectile_action_t   ext_supply_projectile_action;  //补弹状态数据
