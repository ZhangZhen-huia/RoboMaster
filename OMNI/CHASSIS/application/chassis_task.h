...
#define YAW_PID_MAX_OUT           	3.5f //最大输出值
...
//驱动电机速度环
#define DRIVE_MOTOR1_SPEED_PID_KP                 20000.0f
#define DRIVE_MOTOR1_SPEED_PID_KI                 80.0f
#define DRIVE_MOTOR1_SPEED_PID_KD                 10.0f
#define DRIVE_MOTOR1_SPEED_PID_MAX_OUT            16384.0f //最大输出值
#define DRIVE_MOTOR1_SPEED_PID_MAX_IOUT           200.0f //最大输出电流


#define DRIVE_MOTOR2_SPEED_PID_KP                 20000.0f
...
#define DRIVE_MOTOR2_SPEED_PID_MAX_IOUT           200.0f //最大输出电流
																									
																								
#define DRIVE_MOTOR3_SPEED_PID_KP                 30000.0f
#define DRIVE_MOTOR3_SPEED_PID_KI                 80.0f
#define DRIVE_MOTOR3_SPEED_PID_KD                 0.0f
#define DRIVE_MOTOR3_SPEED_PID_MAX_OUT            16384.0f //最大输出值
#define DRIVE_MOTOR3_SPEED_PID_MAX_IOUT           200.0f //最大输出电流
																									
																								
#define DRIVE_MOTOR4_SPEED_PID_KP                 20000.0f
#define DRIVE_MOTOR4_SPEED_PID_KI                 80.0f
#define DRIVE_MOTOR4_SPEED_PID_KD                 0.0f
#define DRIVE_MOTOR4_SPEED_PID_MAX_OUT            16384.0f //最大输出值
#define DRIVE_MOTOR4_SPEED_PID_MAX_IOUT           200.0f //最大输出电流
...
#define CHASSIS_CONTROL_TIME_Z 0.001f  
...
#define CHASSIS_ACCEL_Z_NUM 0.01666667//0.1666666667f
/*******************************轮组数据*******************************/
...
//									0						0
#define NORMAL_MAX_CHASSIS_SPEED_X 3.30f
#define NORMAL_MAX_CHASSIS_SPEED_Y 3.30f
#define NORMAL_MAX_CHASSIS_SPEED_W 3.30f
