...
static void gimbal_init(gimbal_control_t *init)
{
	uint16_t Pitch_offset_ecd = 4065;
	fp32 pitch_max_relative_angle=3807;
	fp32 pitch_min_relative_angle=4501;
	uint16_t Yaw_offset_ecd = 2754;
  ...
  init->gimbal_rc_ctrl = get_remote_control_point();
	...
	init->gimbal_pitch_motor.relative_angle_set = 0;// init->gimbal_pitch_motor.absolute_angle;
	init->gimbal_yaw_motor.relative_angle_set =0;// init->gimbal_yaw_motor.absolute_angle;

}


//fp32 omeg;
extern uint8_t IS_Rotate;
/**
...
//		if(IS_Rotate)
//		{
//			feedback_update->gimbal_pitch_motor.min_relative_angle = 
//		}
//		else
//		{
//			feedback_update->gimbal_pitch_motor.min_relative_angle = 
